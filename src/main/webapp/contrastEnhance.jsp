...
<style type="text/css">
        ...
        .bg {
            background: url('${pageContext.request.contextPath }/images/5.jpg');
            height:670px;
            text-align: center;
            line-height: 900px;
        }
...
<body>
	...
	<div style="width: 599px;float: left;margin-left: 80px;margin-top: 100px;position:absolute;">
		...
		<c:if test="${!empty contrastImagePath}">
			<img alt="" src="../../img/${contrastImagePath}"
				style="border-radius: 10px;">
		</c:if>
		
		<c:if test="${empty contrastImagePath}">
			<img alt="" id="simg" src="${pageContext.request.contextPath }/images/5.jpg" style="border-radius:10px;">
		</c:if>
	...
	<form action="${pageContext.request.contextPath }/contrast/contrastChange.action"
	...
	$(function() {
		$.ajax({
			type : "POST",
			url : "${pageContext.request.contextPath }/contrast/contrastEnhance.action",
